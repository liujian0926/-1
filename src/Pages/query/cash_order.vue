    ...
    <el-tabs v-model="activeName" class="my-tab">
      ...
      <el-tab-pane label="已完成" name="first">
        ...
        <el-form :inline="true" class="demo-form-inline my-form-users">
          ...
          <!--类型选择 -->
          <el-form-item>
            <el-input v-model="finishForm.orderNo" placeholder="提现单号"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        >
          ...
          <el-table-column prop="orderNo" label="提现单号" align="center" width="180px"></el-table-column>
          ...
          <el-table-column prop="paymentAmount" label="提现金额" align="center"></el-table-column>
          <el-table-column prop="rate" label="费率" width="100" align="center"></el-table-column>
          <el-table-column prop="rateType" label="扣手续费方式" width="100" align="center">
      ...
      <el-tab-pane label="已取消" name="second">
       ...
       <el-form :inline="true" class="demo-form-inline my-form-users">
          ...
          <!--类型选择 -->
          <el-form-item>
            <el-input v-model="cancelForm.orderNo" placeholder="提现单号"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        >
          ...
          <el-table-column prop="userId" label="用户ID" align="center"></el-table-column>
          <el-table-column prop="orderNo" label="提现单号" align="center" width="180px"></el-table-column>
          <el-table-column prop="cashIntegral" label="提现积分" align="center"></el-table-column>
          <el-table-column prop="cashAmount" label="提现金额" width="100" align="center"></el-table-column>
          <el-table-column prop="placeOrderTime" label="下单时间" align="center"></el-table-column>
...
export default {
  ...
  methods:{
    ...
    //已完成区域详情
    finishDetail(value){
     this.$router.push({path:"/cash_detail",query:{num:value.orderNo}})
    },
    //已取消语气详情
    cancelDetail(val){
      this.$router.push({path:"/cash_cancel",query:{num:val.orderNo}})
    }
  }
}
</script>
