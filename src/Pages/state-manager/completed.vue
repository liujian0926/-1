<template>
	<div class="container">
		...
		<el-table :data="tableData" border style="width:100%;" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
			...
			<el-table-column prop="updateTime" label="完成处理时间" align="center"></el-table-column>
			<el-table-column prop="customerName" label="处理人" align="center"></el-table-column>
