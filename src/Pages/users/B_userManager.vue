  ...
  <div class="container">
    <el-form :inline="true" class="demo-form-inline my-form-users">
      ...
      >
        ...
        <el-table-column prop="operation" label="会员级别" align="center">
          <template scope="scope">{{scope.row.grant | grant}}</template>
        </el-table-column>
        <el-table-column prop="recommenderName" label="推荐人" align="center"></el-table-column>
        <el-table-column prop="recommenderId" label="推荐人ID" align="center"></el-table-column>
        <el-table-column prop="directPusherCount" label="直推人数" align="center"></el-table-column>
        <el-table-column prop="threeCount" label="三级人数" align="center"></el-table-column>
        ...
        <el-table-column prop="operation" label="操作" align="center">
          <template scope="scope">
            <router-link :to="{path:'/B_detail', query: {userId: scope.row.userId}}"><span style="color:#419EFF" >详情</span></router-link>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$get("/bTerminalUserManage/getBTerminalUserRecords", data).then(res => {
        var data = res.data
        this.tableData = data.bTerminalUserRecords
