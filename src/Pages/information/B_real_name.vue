    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" class="my-tab">
        ...
        >
          ...
          <el-table-column label="实名信息" align="center">
            <template scope="scope">
              <el-button @click.native.prevent="look(scope.row.userId)" type="text" size="small">实名信息</el-button>
            </template>
          </el-table-column>
      ...
      <el-tab-pane label="已拒绝" name="second">
        ...
        >
          ...
          <el-table-column prop="pass,reject" label="操作" align="center">
            <template scope="scope">
              <span style="color:#2386F9" @click="operation(scope.row.userId, 0)">撤回</span>
            </template>
          </el-table-column>
        </el-table>
      </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    authenticationRecord () {
      ...
      this.$get(
        "/transactionDataQuery/getBagencyUserDto", data).then(res => {
        var data = res.data
